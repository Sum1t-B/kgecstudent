...
$query="SELECT * FROM `notice` WHERE dept='$id' ORDER BY id DESC";
$res=mysqli_query($conn,$query);
?>
<!DOCTYPE html>
<html lang="zxx">
<head>
<title>KGEC:NOTICE</title>
<!-- for-mobile-apps -->
...
<body>
 ...
 <!--/banner-section-->
  ...
  <div class="agileits-services w3ls-section" id="agileits-services" >
		<div class="container">
			<h3 class="w3ls-title">Notices </h3>
			<div class="agileits-services-row">
				 <table class="table table-hover">
    <thead>
      <tr>
        <th><h4>Notice Type</h4></th>
        <th><h4>Notice Tag</h4></th>
        <th><h4>Published On</h4></th>
        <th><h4>View</h4></th>
      </tr>
    </thead>
    <tbody>
      ...
      <tr>
        ...
        <td><p><?php echo $row['tag']; ?></p></td>
        <td><p><?php echo $row['date']; ?></p></td>
        <td><p><a href="full_notice.php?id=<?php echo $row['id']; ?>"><button class="btn btn-success">Open</button></a></p></td>
      </tr>
  <?php } ?>
    </tbody>
  </table>
