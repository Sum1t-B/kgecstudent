  ...
  <div class="agileits-services w3ls-section" id="agileits-services" >
		<div class="container">
			...
			<div class="agileits-services-row">
				<a href="notice.php?id=<?php echo $id."1"; ?>"><div class="col-md-6 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>First Year</h4>
				</div></a>
				<a href="notice.php?id=<?php echo $id."2"; ?>"><div class="col-md-6 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>Second Year</h4>
				</div></a>
				<div class="clearfix"> </div>
