...
<body>
 ...
 <!--/banner-section-->
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
							<ul class="nav navbar-nav">
								...
								<li><a href="index.php#portfolio">Institute Information</a></li>
								<li><a href="index.php#team">Representatives</a></li>
								<li><a href="index.php#testimonials" >Updates</a></li>
  ...
  <div class="agileits-services w3ls-section" id="agileits-services" >
		<div class="container">
			<h3 class="w3ls-title">Years </h3>
			<div class="agileits-services-row">
				<a href="notice.php?id=<?php echo $id."1"; ?>"><div class="col-md-3 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>First Year</h4>
				</div></a>
				<a href="notice.php?id=<?php echo $id."2"; ?>"><div class="col-md-3 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>Second Year</h4>
				</div></a>
				<a href="notice.php?id=<?php echo $id."3"; ?>"><div class="col-md-3 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>Third Year</h4>
				</div></a>
				<a href="notice.php?id=<?php echo $id."4"; ?>"><div class="col-md-3 col-sm-6 agileits-services-grids">
					<span class="glyphicon glyphicon-user effect-1" aria-hidden="true"></span>
					<h4>Fourth Year</h4>
				</div></a>
				<div class="clearfix"> </div>
